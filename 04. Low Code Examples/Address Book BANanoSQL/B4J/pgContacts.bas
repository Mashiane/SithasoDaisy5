...
Sub Process_Globals
	...
	'the initial bottom drawer open position
	Private BottomDrawerPos As Double = 0.9		'position to show bottom drawer
...
Public Sub Show(MainApp As SDUI5App)
	...
	BANano.LoadLayout("#bottomdrawercontent", "contactssideview")
...
Private Sub BuildContactsModal
	...
	'set the padding for the form to 0px
	mdlContacts.RemoveFormPadding
	'set the padding for the body to 0px
	mdlContacts.RemoveBodyPadding
	'set the height of the modal to fit contents
	mdlContacts.Height = "fit"
	'set the width of the modal to be 100%
