...
#DesignerProperty: Key: Flexbox, DisplayName: Flex, FieldType: Boolean, DefaultValue: False, Description: Flexible Box
#DesignerProperty: Key: Flex, DisplayName: Flex Size, FieldType: String, DefaultValue: none, Description: Flex, List: 1|auto|initial|none
#DesignerProperty: Key: FlexBasis, DisplayName: Flex Basis, FieldType: String, DefaultValue: , Description: Flex Basis
#DesignerProperty: Key: FlexDirection, DisplayName: Flex Direction, FieldType: String, DefaultValue: none, Description: Display Direction Of Flex Items In The Flex Container, List: col|col-reverse|none|row|row-reverse
...
Sub Class_Globals
	...
	Private sColSpan As String = ""
	Private sColSpanLg As String = ""
	Private sColSpanMd As String = ""
	Private sColSpanSm As String = ""
	Private sColSpanXl As String = ""
	Private sColSpanXs As String = ""
	Private sFlex As String = "none"
	Private sFlexBasis As String = ""
	Private sFlexDirection As String = "none"
	Private sFlexGrow As String = "none"
	Private sFlexShrink As String = "none"
	Private sFlexWrap As String = "none"
	Private bFlexbox As Boolean = False
	Private sGap As String = ""
	Private bGrid As Boolean = False
	Private sGridCols As String = ""
	Private sGridFlow As String = "none"
...
private Sub SetDefaults
	...
	CustProps.Put("Flexbox", False)
	CustProps.Put("Flex", "none")
	CustProps.Put("FlexBasis", "")
	CustProps.Put("FlexDirection", "none")
	CustProps.Put("FlexGrow", "none")
	CustProps.Put("FlexShrink", "none")
	CustProps.Put("FlexWrap", "none")
	CustProps.Put("Text", "")
	...
	CustProps.Put("GridFlow", "none")
	CustProps.Put("GridRows", "")
	CustProps.Put("ColSpan", "")
	CustProps.Put("ColSpanXs", "")
	CustProps.Put("ColSpanSm", "")
	CustProps.Put("ColSpanMd", "")
	CustProps.Put("ColSpanLg", "")
	CustProps.Put("ColSpanXl", "")
	CustProps.Put("Height", "")
	CustProps.Put("Width", "")
	CustProps.Put("Rounded", "none")
	CustProps.Put("RoundedBox", False)
	CustProps.Put("RowSpan", "")
...
'	If sBackgroundColor <> "" Then UI.AddBackgroundColorDT(sBackgroundColor)
	...
	If sColSpanSm <> "" Then UI.AddClassDT("sm:col-span-" & sColSpanSm)
	If sColSpanXl <> "" Then UI.AddClassDT("xl:col-span-" & sColSpanXl)
	If sColSpanXs <> "" Then UI.AddClassDT("xs:col-span-" & sColSpanXs)
	If sFlex <> "" Then UI.AddClassDT("flex-" & sFlex)
	If sFlexBasis <> "" Then UI.AddClassDT("basis-" & sFlexBasis)
	If sFlexDirection <> "" Then UI.AddClassDT("flex-" & sFlexDirection)
	Select Case sFlexGrow
	Case "1"
		UI.AddClassDT("grow")
	Case "0"
		UI.AddClassDT("grow-" & sFlexGrow)
	End Select
...
Sub setFlexDirection(s As String)
	sFlexDirection = s
...
'set Flex Grow
'options: 0|1|none
Sub setFlexGrow(s As String)
	sFlexGrow = s
	CustProps.put("FlexGrow", s)
	If mElement = Null Then Return
	Select Case sFlexGrow
	Case "1"
...
'set Flex Shrink
'options: 0|1|none
Sub setFlexShrink(s As String)
	sFlexShrink = s
	CustProps.put("FlexShrink", s)
	If mElement = Null Then Return
	Select Case sFlexShrink
	Case "1"
...
'options: none|nowrap|wrap|wrap-reverse
Sub setFlexWrap(s As String)
	sFlexWrap = s
...
End Sub
'get Col Span Lg
Sub getColSpanLg As String
	Return sColSpanLg
End Sub
'get Col Span Md
Sub getColSpanMd As String
	Return sColSpanMd
End Sub
'get Col Span Sm
Sub getColSpanSm As String
	Return sColSpanSm
End Sub
'get Col Span Xl
Sub getColSpanXl As String
	Return sColSpanXl
End Sub
'get Col Span Xs
Sub getColSpanXs As String
	Return sColSpanXs
End Sub
'get Flex
...
Sub getFlexBasis As String
	Return sFlexBasis
End Sub
'get Display Direction Of Flex Items In The Flex Container
Sub getFlexDirection As String
	Return sFlexDirection
End Sub
'get Flex Grow
...
Sub getFlexShrink As String
	Return sFlexShrink
End Sub
'get Whether The Flex Items Should Wrap Or Not
Sub getFlexWrap As String
	Return sFlexWrap
End Sub
'get Flexbox
Sub getFlexbox As Boolean
	Return bFlexbox
End Sub
'get Gap
...
End Sub
'get Grid Flow
Sub getGridFlow As String
	Return sGridFlow
End Sub
'get Grid Rows
Sub getGridRows As String
	Return sGridRows
End Sub
'get Height
