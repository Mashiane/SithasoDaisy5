...
Private Sub SetDefaults
	...
	CustProps.Put("Labels", "")
	CustProps.Put("Values", "")
	CustProps.Put("MinValue", "0")
	CustProps.Put("MaxValue", "0")
	CustProps.Put("Gap", "2")
	CustProps.Put("Horizontal", False)
	CustProps.Put("Inside", False)
	CustProps.Put("Point", "")
	CustProps.Put("Radius", "2")
	CustProps.Put("Rotate", "0")
	CustProps.Put("Static", False)
	CustProps.Put("Donut", "")
	CustProps.Put("TooltipDisabled", False)
	CustProps.Put("TooltipFormat", "@L @V")
	CustProps.Put("Weight", "2")
	CustProps.Put("Height", "400px")
	CustProps.Put("Width", "400px")
	CustProps.Put("Shadow", "none")
	CustProps.Put("Rounded", "none")
	CustProps.Put("ShapeColor", "#597BFC")
	CustProps.Put("ShapeOpacity", "1")
	CustProps.Put("ResidualColor", "black")
	CustProps.Put("ResidualOpacity", "0")
	CustProps.Put("TooltipFontColor", "white")
	CustProps.Put("TooltipFontSize", "0.875em")
	CustProps.Put("TooltipFontWeight", "bold")
	CustProps.Put("TooltipRadius", "3px")
	CustProps.Put("TooltipPadding", "3px 4px")
	CustProps.Put("TooltipBackground", "black")
	CustProps.Put("TooltipShadow", "none")
	CustProps.Put("AreaColor", "")
	CustProps.Put("AreaOpacity", "0")
	CustProps.Put("PointInnerColor", "")
	CustProps.Put("PointBorderColor", "")
	CustProps.Put("PointOpacity", "0")
	CustProps.Put("PointOpacityActive", "1")
	CustProps.Put("ShapeColorX", "")
	CustProps.Put("ShapeOpacityActive", "0.5")
