...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	UI.AddStyleDT("background-color", "transparent")
	UI.AddStyleDT("border", "none")
	UI.AddStyleDT("top", "0px")
	UI.AddStyleDT("left", "0px")
	UI.AddStyleDT("bottom", "0px")
	UI.AddStyleDT("right", "0px")
	UI.AddAttrDT("allowfullscreen", "allowfullscreen")
	UI.AddAttrDT("frameborder", "0")
	UI.AddAttrDT("scrolling", "no")
	If bRoundedBox = True Then UI.AddAttrDT("w", bRoundedBox)
	...
	End If
	mElement = mTarget.Append($"[BANCLEAN]<iframe id="${mName}" class="${xclasses}" ${xattrs} style="${xstyles}"></iframe>"$).Get("#" & mName)
	setFileName(sFileName)
	UI.OnEvent(mElement, "load", mCallBack, $"${mName}_load"$)
End Sub
...
Sub setFileName(s As String)			'ignoredeadcode
	...
	If mElement = Null Then Return
	If s = "" Then Return
	UI.AddAttr(mElement, "src", $"./pdfjs/web/viewer.html?file=${sFileName}"$)
End Sub
...
Sub setHeight(s As String)
	...
	If mElement = Null Then Return
	If s <> "" Then UI.SetStyle(mElement, "height", sHeight)
End Sub
...
Sub setWidth(s As String)
	...
	If mElement = Null Then Return
	If s <> "" Then UI.SetStyle(mElement, "width", sHeight)
End Sub
'get File Name
