...
private Sub SetDefaults
	...
	CustProps.Put("CheckBoxType", "normal")
	CustProps.Put("Legend", "Options")
	CustProps.Put("LegendColor", "")
	CustProps.Put("Label", "CheckBox")
	CustProps.Put("LabelColor", "")
	CustProps.Put("TermsConditionsCaption", "")
	CustProps.Put("TermsConditionsUrl", "")
	CustProps.Put("PrivacyPolicyCaption", "")
	CustProps.Put("PrivacyPolicyUrl", "")
	CustProps.Put("Color", "none")
	CustProps.Put("Size", "none")
	CustProps.Put("Checked", False)
	CustProps.Put("CheckedColor", "")
	CustProps.Put("CheckedMarkColor", "")
	CustProps.Put("UncheckedColor", "")
	CustProps.Put("Hint", "")
