...
private Sub SetDefaults
	...
	CustProps.Put("MenuName", "menu1")
	CustProps.Put("ItemType", "normal")
	...
	CustProps.Put("AvatarSize", "16")
	CustProps.Put("AvatarShape", "circle")
	CustProps.Put("Icon", "")
	CustProps.Put("IconSize", "20px")
	CustProps.Put("IconColor", "")
	CustProps.Put("Parent", False)
	CustProps.Put("Active", False)
	CustProps.Put("Badge", "")
	CustProps.Put("BadgeColor", "secondary")
	CustProps.Put("BadgeSize", "xs")
	CustProps.Put("BadgeVisible", False)
	CustProps.Put("Focus", False)
	CustProps.Put("Href", "")
