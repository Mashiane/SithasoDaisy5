...
#DesignerProperty: Key: DirectionOnSmall, DisplayName: Direction On Small, FieldType: String, DefaultValue: horizontal, Description: Direction On Small, List: horizontal|none|vertical
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: , Description: Height
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: , Description: Width
#DesignerProperty: Key: Visible, DisplayName: Visible, FieldType: Boolean, DefaultValue: True, Description: If visible.
#DesignerProperty: Key: Enabled, DisplayName: Enabled, FieldType: Boolean, DefaultValue: True, Description: If enabled.
#DesignerProperty: Key: PositionStyle, DisplayName: Position Style, FieldType: String, DefaultValue: sticky, Description: Position, List: absolute|fixed|none|relative|static|sticky
#DesignerProperty: Key: Position, DisplayName: Position Locations, FieldType: String, DefaultValue: t=?; b=0; r=?; l=?, Description: Position Locations
...
Sub Class_Globals
	...
	Private sPosition As String = "t=?; b=0; r=?; l=?"
	Private sPositionStyle As String = "sticky"
	...
	Private sDirectionOnSmall As String = "horizontal"
	...
	Public CONST DIRECTIONONSMALL_HORIZONTAL As String = "horizontal"
	Public CONST DIRECTIONONSMALL_NONE As String = "none"
	Public CONST DIRECTIONONSMALL_VERTICAL As String = "vertical"
End Sub
...
private Sub SetDefaults
	...
	CustProps.Put("Center", False)
	CustProps.Put("Direction", "none")
	CustProps.Put("DirectionOnSmall", "horizontal")
	CustProps.Put("Height", "")
	CustProps.Put("Width", "")
	CustProps.Put("Visible", True)
	CustProps.Put("Enabled", True)
	CustProps.Put("PositionStyle", "sticky")
	CustProps.Put("Position", "t=?; b=0; r=?; l=?")
...
Sub setDirection(s As String)
	...
	If mElement = Null Then Return
	If s <> "" Then UI.AddClass(mElement, "footer-" & s)
End Sub
'set Direction On Small
'options: horizontal|none|vertical
Sub setDirectionOnSmall(s As String)
	sDirectionOnSmall = s
	CustProps.put("DirectionOnSmall", s)
	If mElement = Null Then Return
	If s <> "" Then UI.AddClass(mElement, "sm:footer-" & s)
End Sub
'set Height
...
Sub getDirection As String
	Return sDirection
End Sub
'get Direction On Small
Sub getDirectionOnSmall As String
	Return sDirectionOnSmall
End Sub
'get Height
