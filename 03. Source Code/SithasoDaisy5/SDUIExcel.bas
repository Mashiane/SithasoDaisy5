...
Sub Class_Globals
	...
	Public const colors_lightslategrey As String = "778899"
	Public const colors_darkviolet As String = "9400D3"
'	Public const colors_cyan As String = "00FFFF"
	Public const colors_darkslateblue As String = "483D8B"
	Public const colors_bisque As String = "FFE4C4"
	Public const colors_lightgrey As String = "D3D3D3"
	Public const colors_khaki As String = "F0E68C"
	Public const colors_darkgray As String = "A9A9A9"
	Public const colors_saddlebrown As String = "8B4513"
	Public const colors_blanchedalmond As String = "FFEBCD"
	Public const colors_darkblue As String = "00008B"
	Public const colors_lightcoral As String = "F08080"
	Public const colors_orangered As String = "FF4500"
	Public const colors_moccasin As String = "FFE4B5"
	Public const colors_azure As String = "F0FFFF"
	Public const colors_lightgoldenrodyellow As String = "FAFAD2"
	Public const colors_skyblue As String = "87CEEB"
	Public const colors_deepskyblue As String = "00BFFF"
	Public const colors_chartreuse As String = "7FFF00"
	Public const colors_mediumpurple As String = "9370DB"
	Public const colors_lightyellow As String = "FFFFE0"
	Public const colors_violet As String = "EE82EE"
	Public const colors_palevioletred As String = "DB7093"
	Public const colors_dimgrey As String = "696969"
	Public const colors_rosybrown As String = "BC8F8F"
	Public const colors_honeydew As String = "F0FFF0"
	Public const colors_mediumblue As String = "0000CD"
	Public const colors_darkseagreen As String = "8FBC8F"
	Public const colors_limegreen As String = "32CD32"
	Public const colors_paleturquoise As String = "AFEEEE"
	Public const colors_mediumorchid As String = "BA55D3"
	Public const colors_burlywood As String = "DEB887"
	Public const colors_silver As String = "C0C0C0"
	Public const colors_papayawhip As String = "FFEFD5"
	Public const colors_chocolate As String = "D2691E"
	Public const colors_lightsteelblue As String = "B0C4DE"
'	Public const colors_pink As String = "FFC0CB"
	Public const colors_darkgreen As String = "006400"
	Public const colors_sienna As String = "A0522D"
	Public const colors_seashell As String = "FFF5EE"
	Public const colors_thistle As String = "D8BFD8"
'	Public const colors_yellow As String = "FFFF00"
	Public const colors_lightseagreen As String = "20B2AA"
	Public const colors_cornsilk As String = "FFF8DC"
	Public const colors_blueviolet As String = "8A2BE2"
	Public const colors_tomato As String = "FF6347"
	Public const colors_cornflowerblue As String = "6495ED"
	Public const colors_sandybrown As String = "F4A460"
	Public const colors_gold As String = "FFD700"
	Public const colors_springgreen As String = "00FF7F"
	Public const colors_gray As String = "808080"
	Public const colors_slategrey As String = "708090"
	Public const colors_mediumvioletred As String = "C71585"
	Public const colors_crimson As String = "DC143C"
	Public const colors_darkcyan As String = "008B8B"
	Public const colors_ivory As String = "FFFFF0"
	Public const colors_darkmagenta As String = "8B008B"
	Public const colors_wheat As String = "F5DEB3"
	Public const colors_indianred As String = "CD5C5C"
	Public const colors_darkorchid As String = "9932CC"
	Public const colors_whitesmoke As String = "F5F5F5"
	Public const colors_mintcream As String = "F5FFFA"
	Public const colors_lightpink As String = "FFB6C1"
'	Public const colors_black As String = "000000"
'	Public const colors_teal As String = "008080"
	Public const colors_cadetblue As String = "5F9EA0"
	Public const colors_beige As String = "F5F5DC"
	Public const colors_darkkhaki As String = "BDB76B"
'	Public const colors_blue As String = "0000FF"
	Public const colors_darkslategray As String = "2F4F4F"
	Public const colors_royalblue As String = "4169E1"
	Public const colors_seagreen As String = "2E8B57"
'	Public const colors_purple As String = "800080"
	Public const colors_orchid As String = "DA70D6"
	Public const colors_forestgreen As String = "228B22"
	Public const colors_darksalmon As String = "E9967A"
	Public const colors_palegreen As String = "98FB98"
	Public const colors_navy As String = "000080"
	Public const colors_lightslategray As String = "778899"
	Public const colors_rebeccapurple As String = "663399"
	Public const colors_greenyellow As String = "ADFF2F"
'	Public const colors_red As String = "FF0000"
	Public const colors_aqua As String = "00FFFF"
'	Public const colors_white As String = "FFFFFF"
	Public const colors_dodgerblue As String = "1E90FF"
'	Public const colors_lightBlue As String = "ADD8E6"
	Public const colors_olive As String = "808000"
	Public const colors_coral As String = "FF7F50"
	Public const colors_peachpuff As String = "FFDAB9"
	Public const colors_darkolivegreen As String = "556B2F"
	Public const colors_darkturquoise As String = "00CED1"
	Public const colors_darkgrey As String = "A9A9A9"
	Public const colors_lavender As String = "E6E6FA"
	Public const colors_lightgray As String = "D3D3D3"
	Public const colors_gainsboro As String = "DCDCDC"
	Public const colors_tan As String = "D2B48C"
	Public const colors_plum As String = "DDA0DD"
	Public const colors_midnightblue As String = "191970"
	Public const colors_powderblue As String = "B0E0E6"
	Public const colors_dimgray As String = "696969"
	Public const colors_lemonchiffon As String = "FFFACD"
	Public const colors_salmon As String = "FA8072"
'	Public const colors_lightGreen As String = "90EE90"
'	Public const colors_brown As String = "A52A2A"
	Public const colors_goldenrod As String = "DAA520"
	Public const colors_steelblue As String = "4682B4"
	Public const colors_lightsalmon As String = "FFA07A"
	Public const colors_darkred As String = "8B0000"
	Public const colors_snow As String = "FFFAFA"
	Public const colors_olivedrab As String = "6B8E23"
	Public const colors_yellowgreen As String = "9ACD32"
'	Public const colors_indigo As String = "4B0082"
	Public const colors_lawngreen As String = "7CFC00"
	Public const colors_magenta As String = "FF00FF"
	Public const colors_aquamarine As String = "7FFFD4"
	Public const colors_floralwhite As String = "FFFAF0"
	Public const colors_antiquewhite As String = "FAEBD7"
	Public const colors_hotpink As String = "FF69B4"
	Public const colors_turquoise As String = "40E0D0"
	Public const colors_peru As String = "CD853F"
	Public const colors_fuchsia As String = "FF00FF"
	Public const colors_firebrick As String = "B22222"
	Public const colors_aliceblue As String = "F0F8FF"
	Public const colors_darkgoldenrod As String = "B8860B"
	Public const colors_navajowhite As String = "FFDEAD"
	Public const colors_lavenderblush As String = "FFF0F5"
	Public const colors_mediumspringgreen As String = "00FA9A"
	Public const colors_slategray As String = "708090"
	Public const colors_mistyrose As String = "FFE4E1"
	Public const colors_linen As String = "FAF0E6"
	Public const colors_darkorange As String = "FF8C00"
	Public const colors_slateblue As String = "6A5ACD"
	Public const colors_lightcyan As String = "E0FFFF"
	Public const colors_lightskyblue As String = "87CEFA"
	Public const colors_mediumseagreen As String = "3CB371"
	Public const colors_mediumturquoise As String = "48D1CC"
	Public const colors_deeppink As String = "FF1493"
	Public const colors_ghostwhite As String = "F8F8FF"
'	Public const colors_green As String = "008000"
'	Public const colors_lime As String = "00FF00"
	Public const colors_mediumaquamarine As String = "66CDAA"
	Public const colors_oldlace As String = "FDF5E6"
'	Public const colors_grey As String = "808080"
'	Public const colors_orange As String = "FFA500"
	Public const colors_darkslategrey As String = "2F4F4F"
	Public const colors_mediumslateblue As String = "7B68EE"
	Public const colors_maroon As String = "800000"
	Public const colors_palegoldenrod As String = "EEE8AA"
	'
