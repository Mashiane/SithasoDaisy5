...
#DesignerProperty: Key: ReadMe, DisplayName: ReadMe, FieldType: String, DefaultValue: Child Item _body|_title|_form|_action, Description: Child Item _body|_title|_form|_action
...
#DesignerProperty: Key: Title, DisplayName: Title, FieldType: String, DefaultValue: Form Card, Description: Title
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		sTitle = Props.GetDefault("Title", "Form Card")
