...
#DesignerProperty: Key: Alignment, DisplayName: Alignment, FieldType: String, DefaultValue: bottom, Description: Alignment, List: bottom|end|start|top
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 48, Description: Height
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 48, Description: Width
...
Sub Class_Globals
	...
	Private sAlignment As String = "bottom"
	Private sHeight As String = "48"
	Private sWidth As String = "48"
...
private Sub SetDefaults
	...
	CustProps.Put("Alignment", "bottom")
	CustProps.Put("Height", "48")
	CustProps.Put("Width", "48")
...
Sub setAlignment(s As String)
	...
	If mElement = Null Then Return
	If s <> "" Then UI.AddClass(mElement, "stack-" & s)
End Sub
'set Height
