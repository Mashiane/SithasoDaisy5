...
#DesignerProperty: Key: ImageHeight, DisplayName: Image Height, FieldType: String, DefaultValue: full, Description: Image Height
#DesignerProperty: Key: ImageWidth, DisplayName: Image Width, FieldType: String, DefaultValue: full, Description: Image Width
...
Sub Class_Globals
	...
	Private sImageHeight As String = "full"
	Private sImageWidth As String = "full"
...
private Sub SetDefaults
	...
	CustProps.Put("ImageHeight", "full")
	CustProps.Put("ImageWidth", "full")
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		sImageHeight = Props.GetDefault("ImageHeight", "full")
		sImageHeight = UI.CStr(sImageHeight)
		sImageWidth = Props.GetDefault("ImageWidth", "full")
