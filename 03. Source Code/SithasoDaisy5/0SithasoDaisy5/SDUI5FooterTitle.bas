...
#DesignerProperty: Key: Text, DisplayName: Text, FieldType: String, DefaultValue: Footer Title, Description: Text
...
Sub Class_Globals
	...
	Private sText As String = "Footer Title"
...
private Sub SetDefaults
	...
	CustProps.Put("Text", "Footer Title")
...
'	If sTextColor <> "" Then UI.AddTextColorDT(sTextColor)
	...
	End If
	mElement = mTarget.Append($"[BANCLEAN]<h6 id="${mName}" class="${xclasses}" ${xattrs} style="${xstyles}">${sText}</h6>"$).Get("#" & mName)
'	setVisible(bVisible)
End Sub
