...
Sub InitLanguages
	...
	Languages.Put("hy", "Armenian ALPHA")
	Languages.Put("az", "Azerbaijani ALPHA")
	Languages.Put("eu", "Basque ALPHA")
	...
	Languages.Put("ka", "Georgian ALPHA")
	Languages.Put("de", "German")
	Languages.Put("el", "Greek")
	Languages.Put("ht", "Haitian Creole ALPHA")
