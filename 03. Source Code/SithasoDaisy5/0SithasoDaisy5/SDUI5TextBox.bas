...
Private Sub SetDefaults
	...
	CustProps.Put("DPCloseOnSelect", False)
	CustProps.Put("DPConjunction", "")
	CustProps.Put("DPShowMonths", 1)
	CustProps.Put("DPTwentyFour", True)
	CustProps.Put("DPLocale", "en")
	CustProps.Put("DPPosition", "auto")
	CustProps.Put("HandleDiameter", 16)
	CustProps.Put("WheelDiameter", 200)
	CustProps.Put("WheelThickness", 20)
	CustProps.Put("WheelPlacement", "top-end")
	CustProps.Put("ToggleColorPicker", False)
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
		...
		sDPDateFormat = Props.GetDefault("DPDateFormat", "Y-m-d")
		...
		bDPTwentyFour = Props.GetDefault("DPTwentyFour", True)
...
Sub setShowEyes(b As Boolean)				'ignoredeadcode
	...
	Select Case sTypeOf
	Case "password"
		sAppendIcon = "./assets/eye-solid.svg"
	Case "text"
...
Sub setTypeOf(s As String)				'ignoredeadcode
	...
	Case "dialer"
		...
		sAppendIcon = "./assets/plus-solid.svg"
