...
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: none, Description: Color, List: accent|error|info|neutral|primary|secondary|success|warning
...
private Sub SetDefaults
	...
	CustProps.Put("Width", "")
	CustProps.Put("IndicatorItem", False)
	CustProps.Put("IndicatorPosition", "top-start")
...
Sub setSize(s As String)
	...
	If mElement = Null Then Return
	If s = "" Then sSize = "md"
	UI.SetSize(mElement, "size", "status", sSize)
End Sub
'set Width
