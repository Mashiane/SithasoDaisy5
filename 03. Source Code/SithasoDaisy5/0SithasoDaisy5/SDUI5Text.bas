...
Private Sub SetDefaults
	...
	CustProps.Put("TextTag", "p")
	CustProps.Put("Icon", "")
	CustProps.Put("IconSize", "")
	CustProps.Put("Text", "Text")
	CustProps.Put("LoremIpsum", False)
	CustProps.Put("Opacity", 100)
	CustProps.Put("ListCol", "none")
	CustProps.Put("FontVariant", "none")
	CustProps.Put("Height", "")
	CustProps.Put("Width", "")
	CustProps.Put("ApplyDefaults", True)
	CustProps.Put("Decoration", "none")
	CustProps.Put("FontWeight", "none")
	CustProps.Put("Italic", False)
	CustProps.Put("Overflow", "none")
	CustProps.Put("TextAlign", "none")
	CustProps.Put("TextColor", "")
	CustProps.Put("TextSize", "none")
	CustProps.Put("Transform", "none")
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If bLoremIpsum Then sText = UI.LoremIpsum(1)
