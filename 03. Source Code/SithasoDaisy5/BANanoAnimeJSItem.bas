...
Public Sub Initialize As BANanoAnimeJSItem
    ...
    Return Me
End Sub
'change the border radius to some value
Sub borderRadius(toValue As Object) As BANanoAnimeJSItem
    change("borderRadius", toValue)
    Return Me
End Sub
Sub fontSize(toValue As Object) As BANanoAnimeJSItem
    change("fontSize", toValue)
    Return Me
End Sub
...
Sub alternate(b As Boolean) As BANanoAnimeJSItem
    ...
    Return Me
End Sub
'set the end value in an object when changing data
Sub propertyEndValue(prop As String, propEndValue As Object) As BANanoAnimeJSItem
    options.Put(prop, propEndValue)
    Return Me
End Sub
'delay
...
'End Sub
'</code>
Sub updateCallBack(Module As Object, methodName As String, elID As String, obj As Map) As BANanoAnimeJSItem
    Dim cb As BANanoObject = BANano.CallBackExtra(Module, methodName, Array(obj), Array(elID))
...
Sub durationCallBack(Module As Object, methodName As String) As BANanoAnimeJSItem
    ...
    Return Me
End Sub
'update value to eg for input fields
...
End Sub
'opacity
Sub opacity(v As Double) As BANanoAnimeJSItem
    If BANano.IsNull(v) Or BANano.IsUndefined(v) Then Return Me
    If v = "" Then Return Me
...
Sub steps(numberOfSteps As Int) As BANanoAnimeJSItem
    ...
    If numberOfSteps = "" Then Return Me
...
Sub right(l As Object) As BANanoAnimeJSItem
    If BANano.IsNull(l) Or BANano.IsUndefined(l) Then Return Me
    If l = "" Then Return Me
    change("right", l)
    Return Me
...
Sub bottom(l As Object) As BANanoAnimeJSItem
    If BANano.IsNull(l) Or BANano.IsUndefined(l) Then Return Me
    If l = "" Then Return Me
    change("bottom", l)
    Return Me
...
Sub visibility(b As Boolean) As BANanoAnimeJSItem
   	If b Then 
		change1("opacity", "0", "1")
	Else
		change1("opacity", "1", "0")
...
End Sub
'change the color
Sub color(bg As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg) Or BANano.IsUndefined(bg) Then Return Me
    If bg = "" Then Return Me
    change("color", bg)
    Return Me
End Sub
'change the color
Sub marginTop(bg As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg) Or BANano.IsUndefined(bg) Then Return Me
    If bg = "" Then Return Me
    change("marginTop", bg)
    Return Me
End Sub
Sub marginRight(bg As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg) Or BANano.IsUndefined(bg) Then Return Me
    If bg = "" Then Return Me
    change("marginRight", bg)
    Return Me
End Sub

Sub marginBottom(bg As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg) Or BANano.IsUndefined(bg) Then Return Me
    If bg = "" Then Return Me
    change("marginBottom", bg)
    Return Me
End Sub

Sub marginLeft(bg As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg) Or BANano.IsUndefined(bg) Then Return Me
    If bg = "" Then Return Me
    change("marginLeft", bg)
    Return Me
End Sub
'change the background color
Sub backgroundColor1(bg1 As String, bg2 As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg1) Or BANano.IsUndefined(bg1) Then Return Me
    Dim points As List
    points.Initialize
    points.Add(bg1)
    points.Add(bg2)
    change("backgroundColor", points)
    Return Me
End Sub
'change the color from to
Sub color1(bg1 As String, bg2 As String) As BANanoAnimeJSItem
    If BANano.IsNull(bg1) Or BANano.IsUndefined(bg1) Then Return Me
    Dim points As List
    points.Initialize
    points.Add(bg1)
...
Sub borderRadius1(fromValue As Object, toValue As Object) As BANanoAnimeJSItem
    change1("borderRadius", fromValue, toValue)
    Return Me
End Sub

'change the border radius from to
Sub scale1(fromValue As Object, toValue As Object) As BANanoAnimeJSItem
    change1("scale", fromValue, toValue)
    Return Me
End Sub
...
End Sub
'rotate
Sub rotate(r As Int) As BANanoAnimeJSItem
...
End Sub
'top
Sub top(w As Object) As BANanoAnimeJSItem
    If BANano.IsNull(w) Or BANano.IsUndefined(w) Then Return Me
    If w = "" Then Return Me
    change("top", w)
    Return Me
