...
#DesignerProperty: Key: TypeOf, DisplayName: Type Of, FieldType: String, DefaultValue: figure, Description: Type Of, List: div|figure
...
Sub Class_Globals
	...
	Private sTypeOf As String = "figure"
	Public CONST TYPEOF_DIV As String = "div"
	Public CONST TYPEOF_FIGURE As String = "figure"
End Sub
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		sWidth = Props.GetDefault("Width", "600px")
		...
		sTypeOf = Props.GetDefault("TypeOf", "figure")
		sTypeOf = UI.CStr(sTypeOf)
	End If
	'
	UI.AddClassDT("hover-gallery")
	...
	End If
	mElement = mTarget.Append($"[BANCLEAN]<${sTypeOf} id="${mName}" class="${xclasses}" ${xattrs} style="${xstyles}"></${sTypeOf}>"$).Get("#" & mName)
End Sub
...
Sub AddImage(imgID As String, imgURL As String) As SDUI5Image
	Dim img As SDUI5Image
	img.Initialize(Me, imgID, imgID)
	img.Src = imgURL
	img.ParentID = mName
	img.Height = ""
	img.Width = ""
