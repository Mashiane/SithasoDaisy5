...
#DesignerProperty: Key: Text, DisplayName: Text, FieldType: String, DefaultValue: Divider, Description: Text
#DesignerProperty: Key: TextPlacement, DisplayName: Text Placement, FieldType: String, DefaultValue: none, Description: Text Placement, List: end|none|start
...
Sub Class_Globals
	...
	Private sText As String = "Divider"
	Public Tag As Object
	Private sColor As String = "none"
	Private sDirection As String = "vertical"
	Private sTextPlacement As String = "none"
	Public CONST DIRECTION_HORIZONTAL As String = "horizontal"
	Public CONST DIRECTION_VERTICAL As String = "vertical"
	Public CONST TEXTPLACEMENT_END As String = "end"
	Public CONST TEXTPLACEMENT_NONE As String = "none"
	Public CONST TEXTPLACEMENT_START As String = "start"
...
private Sub SetDefaults
	...
	CustProps.Put("Text", "Divider")
	CustProps.Put("TextPlacement", "none")
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		sTextPlacement = UI.CStr(sTextPlacement)
...
Sub setDirection(s As String)
	...
	If mElement = Null Then Return
	If s <> "" Then UI.UpdateClass(mElement, "direction", "divider-" & s)
End Sub
'get Color
...
Sub setTextPlacement(s As String)
	sTextPlacement = s
	CustProps.put("TextPlacement", s)
	If mElement = Null Then Return
	If s <> "" Then UI.UpdateClass(mElement, "placement", "divider-" & s)
End Sub

'get Direction
Sub getTextPlacement As String
	Return sTextPlacement
End Sub
