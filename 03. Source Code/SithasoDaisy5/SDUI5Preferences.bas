...
private Sub SetDefaults
	...
	CustProps.Put("Title", "Property Bag")
	CustProps.Put("Card", True)
	CustProps.Put("CardBorder", True)
	CustProps.Put("HasSearch", True)
	CustProps.Put("HasActions", True)
	CustProps.Put("SearchVisible", True)
	CustProps.Put("SearchSize", "sm")
	CustProps.Put("SearchWidth", "300px")
	CustProps.Put("ButtonSize", "sm")
	CustProps.Put("ButtonsOutlined", False)
	CustProps.Put("HasAddNew", False)
	CustProps.Put("AddNewTooltip", "")
	CustProps.Put("HasSave", False)
	CustProps.Put("SaveTooltip", "")
	CustProps.Put("HasDelete", False)
...
Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		bCard = Props.GetDefault("Card", True)
		bCard = UI.CBool(bCard)
		bCardBorder = Props.GetDefault("CardBorder", True)
