...
#DesignerProperty: Key: LGMoveFrom, DisplayName: LG Move From, FieldType: String, DefaultValue: none, Description: L g Move From, List: bottom|end|middle|none|start|top
#DesignerProperty: Key: XLMoveFrom, DisplayName: XL Move From, FieldType: String, DefaultValue: none, Description: X l Move From, List: bottom|end|middle|none|start|top
...
Sub Class_Globals
	...
	Public CONST MOVEFROM_MIDDLE As String = "middle"
	Public CONST MOVEFROM_START As String = "start"
	Public CONST MOVEFROM_TOP As String = "top"
...
private Sub SetDefaults
	...
	CustProps.Put("IsCard", False)
	CustProps.Put("Size", "lg")
	CustProps.Put("Title", "Modal Dialog")
	...
	CustProps.Put("Closable", True)
	CustProps.Put("Backdrop", True)
	CustProps.Put("Glass", False)
	CustProps.Put("ActionsVisible", True)
	CustProps.Put("ActionType", "yes-no")
	CustProps.Put("BottonsWidth", "22")
	CustProps.Put("ButtonsShadow", "md")
	CustProps.Put("ButtonsRounded", "md")
	CustProps.Put("YesCaption", "Yes")
	...
	CustProps.Put("NoVisible", True)
	CustProps.Put("CancelCaption", "Cancel")
	CustProps.Put("CancelTextColor", "#ffffff")
	CustProps.Put("CancelColor", "gray")
	CustProps.Put("CancelLoading", False)
	CustProps.Put("CancelVisible", True)
	...
	CustProps.Put("MoveFrom", "middle")
	CustProps.Put("SMMoveFrom", "none")
	CustProps.Put("MDMoveFrom", "none")
	CustProps.Put("LGMoveFrom", "none")
	CustProps.Put("XLMoveFrom", "none")
...
Sub setClosable(b As Boolean)			'ignoredeadcode
	...
	If mElement = Null Then Return
	If b = False Then
		UI.RemoveElementByID($"${mName}_closeform"$)
	End If
End Sub
'set Glass
...
Sub setLGMoveFrom(s As String)
	sLGMoveFrom = s
	CustProps.put("LGMoveFrom", s)
	If mElement = Null Then Return
	If s <> "" Then UI.AddClass(mElement, "lg:modal-" & s)
End Sub
'set M d Move From
'options: bottom|end|middle|none|start|top
Sub setMDMoveFrom(s As String)
	sMDMoveFrom = s
...
Sub setMoveFrom(s As String)
	sMoveFrom = s
	CustProps.put("MoveFrom", s)
	If mElement = Null Then Return
	If s <> "middle" Then UI.AddClass(mElement, "modal-" & s)
End Sub
'set Open
Sub setOpen(b As Boolean)
	...
	If mElement = Null Then Return
	If b = True Then
		UI.AddClass(mElement, "modal-open")
	Else
		UI.RemoveClass(mElement, "modal-open")
	End If
End Sub
'set S m Move From
'options: bottom|end|middle|none|start|top
Sub setSMMoveFrom(s As String)
	sSMMoveFrom = s
	CustProps.put("SMMoveFrom", s)
	If mElement = Null Then Return
...
'set X l Move From
'options: bottom|end|middle|none|start|top
Sub setXLMoveFrom(s As String)
	sXLMoveFrom = s
	CustProps.put("XLMoveFrom", s)
	If mElement = Null Then Return
	If s <> "" Then UI.AddClass(mElement, "xl:modal-" & s)
End Sub
'get Actions Visible
...
End Sub
'get Backdrop
Sub getBackdrop As Boolean
	Return bBackdrop
End Sub
'get Closable
Sub getClosable As Boolean
	Return bClosable
End Sub
'get Glass
