...
Private Sub SetDefaults
	...
	CustProps.Put("DockItem", False)
	CustProps.Put("ButtonIcon", False)
	CustProps.Put("Text", "Button")
	CustProps.Put("TextVisible", True)
	CustProps.Put("TextSize", "")
	CustProps.Put("TextColor", "")
	CustProps.Put("Color", "none")
	CustProps.Put("Badge", "")
	CustProps.Put("BadgeColor", "")
	CustProps.Put("BadgeSize", "sm")
	CustProps.Put("Active", False)
	CustProps.Put("Tooltip", "")
	...
	CustProps.Put("Wide", False)
	CustProps.Put("Dash", False)
	CustProps.Put("Ghost", False)
	CustProps.Put("JoinItem", False)
	CustProps.Put("Activator", False)
	CustProps.Put("PopOverTarget", "")
	CustProps.Put("RoundedField", False)
	CustProps.Put("Link", False)
	CustProps.Put("Loading", False)
	CustProps.Put("Outline", False)
	CustProps.Put("LeftIcon", "")
	CustProps.Put("LeftIconColor", "")
	CustProps.Put("IconSize", "50")
	CustProps.Put("RightIcon", "")
	CustProps.Put("RightIconColor", "")
	CustProps.Put("Image", "")
	CustProps.Put("ImageHeight", "32px")
	CustProps.Put("ImageWidth", "32px")
	CustProps.Put("RightImage", "")
	CustProps.Put("RightImageHeight", "32px")
	CustProps.Put("RightImageWidth", "32px")
	CustProps.Put("Size", "md")
	CustProps.Put("SizeLarge", "none")
	CustProps.Put("SizeMedium", "none")
	CustProps.Put("SizeSmall", "none")
	CustProps.Put("SizeXLarge", "none")
	CustProps.Put("Soft", False)
	CustProps.Put("Height", "")
	CustProps.Put("Width", "")
	CustProps.Put("Shadow", "md")
	CustProps.Put("IndicatorVisible", False)
	CustProps.Put("IndicatorValue", "")
	CustProps.Put("IndicatorColor", "error")
	CustProps.Put("IndicatorTextColor", "none")
	CustProps.Put("IndicatorPosition", "top-end")
	CustProps.Put("IndicatorSize", "6")
