...
Sub Process_Globals
	...
	Private SDUI5OfficeRibbon1 As SDUI5OfficeRibbon
End Sub
...
Sub Show(MainApp As SDUI5App)
	...
	Dim splitB As Map = SDUI5OfficeRibbon1.AddSplitButton("home.clipboard.col1", "paste", "e-icons e-paste", "Paste")
	SDUI5OfficeRibbon1.AddSplitButtonItem(splitB, "keepsourceformat", "Keep Source Format")
	SDUI5OfficeRibbon1.AddSplitButtonItem(splitB, "mergeformat", "Merge format")
	SDUI5OfficeRibbon1.AddSplitButtonItem(splitB, "keeptextonly", "Keep text only")
	...
	SDUI5OfficeRibbon1.AddColorPicker("home.font.col2", "colorpicker", "#123456").SetItemSizeSmall("home.font.col2", "colorpicker")
	...
	Dim bg1 As Map = SDUI5OfficeRibbon1.AddGroupButton("home.font.col3", "bg1", 0)
	SDUI5OfficeRibbon1.AddGroupButtonItem(bg1, "gbbold", "e-icons e-bold", True)
	SDUI5OfficeRibbon1.AddGroupButtonItem(bg1, "gbitalic", "e-icons e-italic", False)
	SDUI5OfficeRibbon1.AddGroupButtonItem(bg1, "gbunderline", "e-icons e-underline", False)
	SDUI5OfficeRibbon1.AddGroupButtonItem(bg1, "gbstrikethrough", "e-icons e-strikethrough", False)
	SDUI5OfficeRibbon1.AddGroupButtonItem(bg1, "gbcase", "e-icons e-change-case", False)
	...
	'
	Dim tbl As Map = SDUI5OfficeRibbon1.AddSplitButton("insert.tables.col1", "table", "e-icons e-table", "Table")
	SDUI5OfficeRibbon1.SetItemSizeLarge("insert.tables.col1", "table")
	SDUI5OfficeRibbon1.AddSplitButtonItem(tbl, "inserttable", "Insert Table")
	SDUI5OfficeRibbon1.AddSplitButtonItem(tbl, "drawtable", "Draw Table")
	SDUI5OfficeRibbon1.AddSplitButtonItem(tbl, "converttable", "Convert Table")
	SDUI5OfficeRibbon1.AddSplitButtonItem(tbl, "excelspreadsheet", "Excel SpreadSheet")
