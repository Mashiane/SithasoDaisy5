...
Sub Process_Globals
	...
	Private SDUI5Window1 As SDUI5Window		'ignore
...
Sub Show
	...
	'
	SDUI5Window1.Initialize(Me, "SDUI5Window1", "SDUI5Window1")
	SDUI5Window1.ParentID = "SDUI5Column1"
	BANano.Await(SDUI5Window1.AddComponent)
	'
	SDUI5Panel1.Initialize(Me, "SDUI5Panel1", "SDUI5Panel1")
	SDUI5Panel1.ParentID = "SDUI5Window1"
	...
	pgIndex.UpdateTitle("SDUI5Window")
End Sub
