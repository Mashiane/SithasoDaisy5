...
Sub Show			'ignore
	...
	'
	tblColumns.Initialize(Me, "tblColumns", "tblColumns")
	tblColumns.ParentID = "SDUI5Column3"
	tblColumns.AddNewTooltip = "Add a new"
	tblColumns.BackTooltip = "Go back to dashboard"
	tblColumns.ButtonSize = "sm"
	tblColumns.DeleteTooltip = "Delete"
	'tblColumns.DownloadToolbarTooltip = ""
	tblColumns.EditTooltip = "Edit"
	'tblColumns.ExportToCsv = False
	tblColumns.HasAddnew = False
	tblColumns.HasAlphaChooser = False
	tblColumns.HasBack = False
	tblColumns.HasColumnChooser = False
	tblColumns.HasDelete = False
	tblColumns.HasEdit = False
	tblColumns.HasRefresh = False
	tblColumns.HasSaveSingle = True
	tblColumns.HasToolbarUpload = True
	tblColumns.ItemsPerPage = "100"
	tblColumns.NormalCase = True
	tblColumns.Pagination = False
	tblColumns.RefreshTooltip = "Refresh"
	tblColumns.Shadow = "md"
	tblColumns.Title = "Excel File Columns"
	BANano.Await(tblColumns.AddComponent)
