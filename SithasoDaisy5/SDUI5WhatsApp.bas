        ...
        <div id="${mName}_sideheader" class="wa-chat-header">
			<div class="flex">
				<button id="${mName}_back" class="btn btn-ghost btn-circle hidden mr-2 tooltip tooltip-right" data-tip="Exit Messenger">
					<svg id="${mName}_backicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/chevron-left-solid.svg"></svg>
				</button>
            	<div class="wa-avatar">
			...
			<div id="${mName}_sideactions" class="wa-chat-header-right items-center">
				...
				<button id="${mName}_refreshchats" class="btn btn-ghost btn-circle ml-2 tooltip tooltip-left" data-tip="Refresh Chats">
					<svg id="${mName}_refreshchatsicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/rotate-solid.svg"></svg>
				</button>
            </div>
        </div>
    ...
    <div id="${mName}_rightsection" class="wa-message-container">
        ...
        <div id="${mName}_footer" class="wa-message-footer">
			<button id="${mName}_emoji" data-tip="Send Emoji" class="btn btn-ghost btn-circle tooltip tooltip-right">
				<svg id="${mName}_emojiicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/face-smile-solid.svg"></svg>
			</button>
			<button id="${mName}_attach" class="btn btn-ghost btn-circle mr-2 tooltip tooltip-right" data-tip="Send Document, Image or Video">
				<svg id="${mName}_attachicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/paperclip-solid.svg"></svg>
			</button>
			...
			<button id="${mName}_cancelreply" data-tip="Cancel Reply" class="btn btn-ghost btn-circle ml-2 hidden tooltip tooltip-left">
				<svg id="${mName}_cancelreplyicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/xmark-solid.svg"></svg>
			</button>
            <button id="${mName}_send" data-tip="Send Message" class="btn btn-ghost btn-circle ml-2 tooltip tooltip-left hidden">
				<svg id="${mName}_sendicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/paper-plane-solid.svg"></svg>
			</button>
			<button id="${mName}_voice" class="btn btn-ghost btn-circle ml-2 ">
				<svg id="${mName}_voiceicon" style="pointer-events:none;" data-unique-ids="disabled" class="rounded-full" fill="currentColor" data-js="enabled" data-src="./assets/microphone.svg"></svg>
			</button>
        </div>
