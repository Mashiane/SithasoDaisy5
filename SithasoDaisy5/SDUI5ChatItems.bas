...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: screen, Description: Height
...
Sub Class_Globals
	...
	Private sHeight As String = "screen"
...
Public Sub DesignerCreateView (Target As BANanoElement, Props As Map)
	...
	If Props <> Null Then
		...
		sHeight = Props.GetDefault("Height", "screen")
