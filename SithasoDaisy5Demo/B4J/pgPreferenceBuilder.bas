...
Sub ShowPropertiesByType(item As String)
	...
	'show necessary ones
	BANano.Await(compToAdd.ShowProperty(Array("proppos", "propname", "proptitle", "propdatatype", "propvalue", "proprequired", "propenabled", "propvisible")))
	...
	Case "textarea"
		...
		compToAdd.SetPropertyValues(CreateMap("propname": "textarea1", "proptitle": "Text Area", "propvalue": "", "proprequired": True, "proprows":"4"))
	Case "select"
	...
	Case "filter"
		...
		compToAdd.SetPropertyValues(CreateMap("propname": "filter1", "proptitle": "Filter", "propvalue": "spar;quadbike", "proprequired": False, _
		"propoptions": "spar:Spar; boatride:Boat Ride; horseride:Horse Ride; quadbike: Quad Bike; helicopter:Helicopter", "propcolor": "neutral", "propactivecolor":"#22c55e"))
	End Select	
	'
