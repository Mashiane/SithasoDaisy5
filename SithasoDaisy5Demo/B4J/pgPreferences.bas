...
Sub Show(MainApp As SDUI5App)
	...
	propbag.AddPropertySelect("select1", "Select", "b4j", "", True, "", _
	...
	propbag.AddPropertyFileInput("fileinput1", "File Input 1", "", "")
	...
	propbag.AddPropertyRadioGroup("radiogroup1", "Radio Group", "b4r", "primary", "", "", _
	CreateMap("b4a": "Basic 4 Android", "b4i": "Basic 4 iPhone", "b4j": "Basic 4 Java", "b4r": "Basic 4 Arduino"))
